...
namespace MalbersAnimations.InputSystem
{
    ...
    public class MInputLink : MonoBehaviour, IInputSource
    {
        ...
        {
            playerInput = null; //Remove the Player input 
        }
        ...
        void OnEnable()
        {
            ...
            if (playerInput == null) { playerInput = this.FindComponent<PlayerInput>(); }
        ...
        public void OnMove(InputAction.CallbackContext context)
        {
            ...
            MoveAxis.x = ActiveMActionMap.IgnoreHorizontal ? 0 : move2D.x; //Catch the Horizontal Axis
            MoveAxis.z = ActiveMActionMap.IgnoreForward ? 0 : move2D.y; //Catch the Forward Axis
        ...
        public void OnUpDown(InputAction.CallbackContext context)
        {
            ...
            MoveAxis.y = ActiveMActionMap.IgnoreUpDown ? 0 : UpDown; //Catch the Up Down Axis
            character?.SetInputAxis(MoveAxis);
        ...
        {
            var input = ActiveMActionMap.buttons.Find(x => x.Name == name);
        ...
        internal void FindButtons()
        {
            ...
            m_MapButtons ??= new List<MInputActionMap>(InputActions.actionMaps.Count);
        ...
        private void ConnectSpeedUP()
        {
            ...
            if (input != null)
            {
                ...
                var method = this.GetUnityAction<bool>("MAnimal", "SpeedUp");
        ...
        private void ConnectSpeedDown()
        {
            ...
            if (input != null)
            {
                ...
                var method = this.GetUnityAction<bool>("MAnimal", "SpeedDown");
    ...
    public class MInputActionMap
    {
        ...
        public BoolReference IgnoreForward = new();
        public BoolReference IgnoreHorizontal = new();
        public BoolReference IgnoreUpDown = new();
    ...
    public class MInputAction : IInputAction
    {
        ...
        private void DebbugInput(bool value)
        {
            ...
            if (debug)
            {
                Debug.Log($"<color=cyan><B>[Input {name} - {interaction} : {value}]</B></color>");
            }
#endif
        }
    ...
    {
        private readonly string versionInput = "Input Link [v2.0.2a]";

        //protected ReorderableList list;
        protected SerializedProperty
            m_Buttons, InputActions, m_MapButtons, showInputEvents, playerInput, Editor_Tabs1,
        ...
        private void CheckActionMaps(bool DifferentMapButton)
        {
            if (M.InputActions != null)
            {
                ...
                if (M.m_MapButtons == null) M.m_MapButtons = new(); //Make sure is not null
        ...
        public override void OnInspectorGUI()
        {
            ...
            MalbersEditor.DrawDescription(versionInput + ActiveActionMapName);
        ...
        private void DrawButtons()
        {
            if (InputActions.objectReferenceValue != null)
            {
                ...
                var IgnoreForward = actionMap.FindPropertyRelative("IgnoreForward");
                var IgnoreUpDown = actionMap.FindPropertyRelative("IgnoreUpDown");
                var IgnoreHorizontal = actionMap.FindPropertyRelative("IgnoreHorizontal");
                ...
                using (new GUILayout.VerticalScope(EditorStyles.helpBox))
                {
                    ...
                    IgnoreForward.isExpanded = MalbersEditor.Foldout(IgnoreForward.isExpanded, "Ignore Axis");

                    if (IgnoreForward.isExpanded)
                    {
                        EditorGUILayout.PropertyField(IgnoreForward);
                        EditorGUILayout.PropertyField(IgnoreUpDown);
                        EditorGUILayout.PropertyField(IgnoreHorizontal);
                    }
        ...
        protected void DrawInputEvents(SerializedProperty Element, int index)
        {
            using (new GUILayout.VerticalScope(EditorStyles.helpBox))
            {
                ...
                Element.isExpanded = EditorGUILayout.Foldout(Element.isExpanded,
                    new GUIContent(Element.FindPropertyRelative("name").stringValue + " Properties"));
                EditorGUI.indentLevel--;
