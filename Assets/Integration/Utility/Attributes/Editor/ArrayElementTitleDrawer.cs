            ...
            switch (TitleNameProp.propertyType)
            {
                ...
                case SerializedPropertyType.ObjectReference:
                    if(TitleNameProp.objectReferenceValue == null)
                        break;
                    if(TitleNameProp.objectReferenceValue is GameObject)
                        return ((GameObject)TitleNameProp.objectReferenceValue).name;
                    if(TitleNameProp.objectReferenceValue is Transform)
                        return ((Transform)TitleNameProp.objectReferenceValue).name;
